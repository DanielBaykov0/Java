...
public class Main {
    ...
    private static void printAllMistakesResult(Set<Method> mistakesGetters, Set<Method> mistakesSetters, Set<Field> mistakesFields) {
        mistakesFields.forEach(field -> System.out.println(String.format("%s must be private!", field.getName())));

        mistakesGetters.forEach(method -> System.out.println(String.format("%s have to be public!", method.getName())));

        mistakesSetters.forEach(method -> System.out.println(String.format("%s have to be private!", method.getName())));
    }
